  ...
  if (pageEditForm) {
    pageEditForm.addEventListener(
      ...
      function(e) {
        ...
        pageEditForm.querySelectorAll(".error-message").forEach((el2) => el2.textContent = "");
        fetch(url, {
          method: "POST",
          headers: {
            "X-CSRF-TOKEN": csrfToken,
